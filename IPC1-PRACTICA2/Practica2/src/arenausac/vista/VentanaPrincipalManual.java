...
public class VentanaPrincipalManual extends JFrame{
    ...
    public VentanaPrincipalManual() {
        ...
        barraP1 = new JProgressBar(0,500);
        barraP2 = new JProgressBar(0,500);
        ...
        JPanel panelVida = new JPanel(new GridLayout(2,1));
        panelVida.add(barraP1);
        panelVida.add(barraP2);
    ...
    private void initComponentes() {
        ...
        btnBatalla.addActionListener(e -> {
            try {
                ...
                if (p1 != null && p2 != null) {
                    new Thread(() -> {
                        Batalla batalla = new Batalla(p1, p2, historial, areaTexto, barraP1, barraP2);
                        batalla.iniciar();
                    }).start();
        ...
        btnHistorial.addActionListener(e -> {
            areaTexto.append("Mostrando el historial");
            historial.mostrarHistorial(areaTexto);
        });
